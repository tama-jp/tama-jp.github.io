((a, b, c) => {
  const d = d => ({
    ...
    "Background Fetch": "backgroundFetch" in d,
    ...
    "Web Share (Level 1)": "share" in c,
    "Web Share (Level 2)": "share" in c && "canShare" in c,
    ...
    "Payment Handler": "paymentManager" in d,
    "Credential Management": "credentials" in c && "preventSilentAccess" in c.credentials && ("PasswordCredential" in a || "FederatedCredential" in a)
  }), e = a => {
